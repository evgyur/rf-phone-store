...
- Reject: brutalist borders, red poster accents, oversized decorative typography, black boxed sections, internal project explanations in customer-facing copy.
...
4. Payment: choose card, SBP, pay on delivery, or installment; show card fields and validation example.
